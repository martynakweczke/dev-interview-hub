...
type ProgressStore = typeof import("@/features/progress/services/progress-store/progress-store")
...
describe("progress store", () => {
  ...
  beforeEach(async () => {
    localStorage.clear()
    vi.resetModules()
    store = await import("@/features/progress/services/progress-store/progress-store")
  })
