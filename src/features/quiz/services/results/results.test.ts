...
describe("getResultsCopy", () => {
  it.each([
    [
      10,
      "Outstanding round — this topic is locked in.",
      "A perfect score. Retry any time to keep it sharp.",
    ],
    [
      9,
      "Outstanding round — this topic is locked in.",
      "Nearly perfect. Retry any time to keep it sharp.",
    ],
    [
      8,
      "Strong round — you're interview-ready on the basics.",
      "2 to review. Retry to lock them in.",
    ],
    [
      7,
      "Strong round — you're interview-ready on the basics.",
      "3 to review. Retry to lock them in.",
    ],
    [
      6,
      "Solid effort — a few real gaps here.",
      "4 questions to review before your next attempt.",
    ],
    [
      4,
      "Solid effort — a few real gaps here.",
      "6 questions to review before your next attempt.",
    ],
    [
      3,
      "Good start — let's review the fundamentals.",
      "7 questions to review. Another round will help it stick.",
    ],
    [
      0,
      "Good start — let's review the fundamentals.",
      "10 questions to review. Another round will help it stick.",
    ],
