...
function AnswerCell({
  ...
  return (
    <div role="cell" className="text-cell wrap-anywhere max-sm:col-start-2 max-sm:text-meta">
  ...
  return (
    <div
      ...
      className={cn(
        ...
        isCorrect ? toneClasses.correct : [toneClasses.incorrect, "bg-incorrect-row"]
      )}
    >
      <div role="cell" className="font-mono text-meta text-ink-faint">
        {String(number).padStart(2, "0")}
      </div>
      <div role="rowheader" className="text-row wrap-anywhere text-ink-secondary">
